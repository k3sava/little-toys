...
const TOYS = [
  ...
  },
  {
    ...
    name: "pixart",
    category: "Visual",
    keywords: "image, video, effects, canvas, generative, ascii, dither, crt, halftone, scatter",
    description: "Drop an image or video, pick an effect. 16 canvas image/video effects (ascii, bevel, cellular, crt, displace, distort, dithering, dots, edge, gradients, patterns, recolor, scatter, slide, stack, stippling) reverse-engineered from tooooools.app. 15 s seamless loop, PNG + MP4 export, keyboard shortcuts.",
    subpaths: [
      "",
