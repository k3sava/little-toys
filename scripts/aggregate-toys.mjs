...
const TOYS = [
  ...
  },
  {
    ...
    description: "Drop an image or video, pick an effect. 28 client-side canvas image/video effects (ascii, bevel, cellular, contour, crt, displace, distort, dithering, dots, edge, film-grain, flow-field, gradients, halftone-cmyk, ink-wash, kaleidoscope, patterns, pixel-sort, recolor, rgb-shift, scatter, slide, slit-scan, stack, stippling, voronoi, watercolor, zoom-blur). 15 s seamless loop, per-effect mode systems, PNG + MP4 export, keyboard shortcuts.",
    subpaths: [
      "",
      ...
      "slide/effect.js", "slide/index.html",
      ...
      "zoom-blur/effect.js", "zoom-blur/index.html",
      ...
      "assets/thumbs/cellular.webp", "assets/thumbs/contour.webp",
      ...
      "assets/thumbs/patterns.webp", "assets/thumbs/pixel-sort.webp",
      "assets/thumbs/recolor.webp", "assets/thumbs/rgb-shift.webp",
      "assets/thumbs/scatter.webp", "assets/thumbs/slide.webp",
      "assets/thumbs/slit-scan.webp", "assets/thumbs/stack.webp",
      "assets/thumbs/stippling.webp", "assets/thumbs/voronoi.webp",
      "assets/thumbs/watercolor.webp", "assets/thumbs/zoom-blur.webp",
      "assets/previews/ascii.mp4", "assets/previews/bevel.mp4",
      "assets/previews/cellular.mp4", "assets/previews/contour.mp4",
      ...
      "assets/previews/patterns.mp4", "assets/previews/pixel-sort.mp4",
      "assets/previews/recolor.mp4", "assets/previews/rgb-shift.mp4",
      "assets/previews/scatter.mp4", "assets/previews/slide.mp4",
      "assets/previews/slit-scan.mp4", "assets/previews/stack.mp4",
      "assets/previews/stippling.mp4", "assets/previews/voronoi.mp4",
      "assets/previews/watercolor.mp4", "assets/previews/zoom-blur.mp4",
    ],
  },
  {
    slug: "wordart",
